...
@section('contenido')
    ...
    <form action="/usuarios/{{$usuario->id}}" method="POST">
        ...
        <div class="mb-3">
            ...
            <input value="{{$usuario->nombre}}" class="form-control" id="nombre" name="nombre" onkeydown="return /[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]/i.test(event.key)" type="text"
                required />
            <label for="" class="form-label">Apellido paterno</label>
            <input value="{{$usuario->apellido_paterno}}" class="form-control" id="apellido_paterno" name="apellido_paterno"
                onkeydown="return /[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]/i.test(event.key)" type="text" required />
            <label for="" class="form-label">Apellido materno</label>
            <input value="{{$usuario->apellido_materno}}" class="form-control" id="apellido_materno" name="apellido_materno"
                onkeydown="return /[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]/i.test(event.key)" type="text" required />
            <label for="" class="form-label">Fecha de Nacimiento</label>
            <input value="{{$usuario->fecha_nacimiento}}" class="form-control" id="fecha_nacimiento" name="fecha_nacimiento" type="date" max="2000-01-01"
                required />
            <label for="" class="form-label">Sexo</label>
            <select value="{{$usuario->sexo}}" class="form-control" name="sexo" id="sexo">
            ...
            <input value="{{$usuario->calle}}" class="form-control" id="calle" name="calle" onkeydown="return /[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]/i.test(event.key)" type="text"
                required />
            <label for="" class="form-label">Numero</label>
            <input value="{{$usuario->numero_exterior}}" class="form-control" id="numero_exterior" name="numero_exterior" type="number" required />
            <label for="" class="form-label">Numero interior</label>
            <input value="{{$usuario->numero_interior}}" class="form-control" id="numero_interior" name="numero_interior" type="number" />
            <label for="" class="form-label">Colonia</label>
            <input value="{{$usuario->colonia}}" class="form-control" id="colonia" name="colonia" onkeydown="return /[a-zA-ZñÑáéíóúÁÉÍÓÚ\s]/i.test(event.key)"
                type="text" required />
            <h3>Datos Extra</h3>
